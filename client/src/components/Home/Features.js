...
const Features = () => {
  ...
  <section className='features relative mt-12 items-center' >
    ...
    <article className='flex w-full justify-center items-center mt-10 pr-1' >
      <img src='images/spicy-craving.png' className='w-2/3' alt='spicy craving'/>
      <div>
        <h5 className='font-bold text-primary text-3xl lg:text-5xl w-full my-auto text-right' > Burger <br/> <span className='text-secondary'>Fries</span> <div className='underline ml-auto bg-primary mt-1 w-1/2'></div></h5>
    ...
    <article className='flex w-full mt-10 justify-center items-center pl-2' >
      <div>
        <h5 className='font-bold text-primary text-3xl lg:text-5xl w-full my-auto text-left' > <span className='text-secondary'>Sweet</span> <br/> Cravings <div className='underline mr-auto bg-secondary w-1/2'></div></h5>
