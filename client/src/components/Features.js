...
const Features = () => {
  return  <>
  <section className='features relative mt-2 items-center' >
    ...
    <article className='flex w-full justify-center mt-10 pr-1' >
      <img src='images/spicy-craving.png' className='w-2/3' alt='spicy craving image'/>
      <div>
    ...
    <article className='flex w-full mt-10 justify-center items-center pl-2' >
      ...
      <img src='images/sweet-craving.png' className='w-2/3' alt='spicy craving image'/>
    </article>
  </section>
  <div className='text-center my-5'><button className='border-4 w-40 text-center border-secondary rounded-lg p-1.5'>See Complete Menu</button></div>
  </>
}
